...
// Query untuk mendapatkan transaksi hanya untuk toko dengan id_penjual tertentu
$query_orders = "
SELECT 
...
WHERE orders.id_pesanan = '$id_penjual'
";
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-end">
                        <a href="utamapenjual.php?page=transaksidetail&id_pembayaran=<?php echo $row['id_pembayaran']; ?>" class="btn btn-md rounded font-sm">Detail</a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
