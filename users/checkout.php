...
// Menghitung total harga, berat, dan mengumpulkan data keranjang
while ($row = $result->fetch_assoc()) {
    $cart_items[] = $row;
    $total_price += $row['price'] * $row['quantity'];
    $total_weight += $row['berat'] * $row['quantity']; // Menghitung total berat
}
    ...
    <div class="container my-5">
        ...
        <form action="utama.php?page=proses_checkout.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" name="weight" id="weight" class="form-control" value="<?= $total_weight ?>" readonly>
            </div>
            <div class="form-group">
