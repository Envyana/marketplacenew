...
$query = "SELECT id_produk, id_kategori, nama_produk, deskripsi, harga, ketersediaan_stok, warna, ukuran, gambar FROM produk";
            ...
            <?php if (mysqli_num_rows($result) > 0): ?>
                ...
                <div class="table-header mb-3">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-2 col-sm-2 col-4"><strong>Berat</strong></div>
                    </div>
                </div>
                <!-- List Produk -->
                <?php
                    ...
                    <article class="itemlist mb-3">
                        ...
                        <div class="row mt-2">
                            <div class="col-12 text-end">
                                <a href="utama.php?page=editproduct&id=<?php echo $row['id_produk']; ?>" class="btn btn-sm btn-brand">
                                    <i class="material-icons md-edit"></i> Edit
                                </a>
                                <a href="deleteproduct.php?id=<?php echo $row['id_produk']; ?>" class="btn btn-sm btn-light" onclick="return confirm('Anda yakin ingin menghapus produk ini?');">
