    ...
    <aside class="navbar-aside" id="offcanvas_aside">
        ...
        <nav>
            <ul class="menu-aside">
                ...
                <li class="menu-item">
                    <a class="menu-link" href="utama.php?page=categories">
                ...
                <li class="menu-item">
                    <a class="menu-link" href="utama.php?page=seller">
                        <i class="icon material-icons md-store"></i>
                        <span class="text">Akun Penjual</span>
                    </a>
                </li>
                <li class="menu-item">
                    <a class="menu-link" href="utama.php?page=users">
                        <i class="icon material-icons md-person"></i>
                        <span class="text">Akun Pembeli</span>
                    </a>
                </li>
                <li class="menu-item">
        ...
        <section class="content">
            ...
            if (isset($_GET['page'])) {
                if ($_GET['page'] == 'utama') { 
                    ...
                    include "users.php";
                } elseif ($_GET['page'] == 'usersdetail') { 
                    include "usersdetail.php";
                } elseif ($_GET['page'] == 'seller_detail') { 
