...
<section class="content-main">
    <div class="content-header">
        ...
        <div>
            <a href="utama.php?page=addcategories" class="btn btn-primary"><i class="material-icons md-plus"></i> Buat Baru</a>
        </div>
    </div>
    <div class="card mb-4">
        <div class="card-body">
            <div class="table-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-3 col-sm-3 col-6 col-name"><strong>Nama Kategori</strong></div>
                </div>
            </div>
            <hr>
        <?php
